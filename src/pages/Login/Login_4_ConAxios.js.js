...
//      Backupeado como Login_4_ConAxios.js
...
const Login = () => {
    ...
    const onClickSubmitLogin = async (e) => {
        ...
        try{
            ...
            console.log('Entro al onClickSubmitLogin: Tenemos Email: -> ' +  email + ", la Password es: " + password);
            ...
            if (token) {
                ...
                window.location.replace("/home");  //con window.location.replace -->  recarga la pagina /home y toma el cambio de usuario
                
                //Faltaría acá ir a recuperar los datos del usuario para poner el nombre del usuario en vez del mail
                //nombre = RecuperaNombreUsuario(token o mail) //tengo que ver como lo hace el form User.js
                //guardar tambien el nombre el local storage
